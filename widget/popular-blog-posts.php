<?php
add_action('widgets_init', 'theme_popular_blog_posts_widget_register');

function theme_popular_blog_posts_widget_register() {
	register_widget('Theme_PopularBlogPosts_Widget');
}

class Theme_PopularBlogPosts_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'popular_blog_posts_widget',
			esc_attr__('Theme Popular Posts', 'theme'),
			array('description' => esc_attr__('Shows popular posts', 'theme'))
		);
	}
